...
const balanceImage = new Image(60, 60);
      balanceImage.src = "../assets/images/happyWallet.png";
...
// background
const backgroundIMG = new Image(1920, 1080);
      backgroundIMG.src = "../assets/images/background.jpg"
const backgroundXpos = canvas.width/2;
const backgroundYpos = canvas.height/2;
...
const menuTextYPosition = 600; 
const coinyTextXposition = 200;
const coinyTextYposition = 400;
const coinyOverColor = "yellow";
const menuSecondText = "Press space to flap wings";
const menuTextSize = 60;
const menuTextColor = "yellow";
const menuOvercolor = "green";
const gameOverText = "You Died and got " + coinBalance + " coins, press " + restartKey + " to restart" ;